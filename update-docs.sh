...
./kernel-doc-text-to-markdown.py ${KERNEL} ${WEBSITE} \
	drivers/lego/brickpi/brickpi_{battery,ld,i2c_sensor}.c \
	drivers/lego/core/lego_port_class.c \
	drivers/lego/ev3/legoev3_motor.c \
	...
	drivers/lego/pistorms/pistorms_core.c \
...
rm -f ${WEBSITE}/docs/motors/*.markdown
./motor-defs-to-markdown.py \
	--kernel ${KERNEL} \
	--website ${WEBSITE} \
	--header-files \
		drivers/lego/motors/ev3_motor.h \
	--source-files \
		drivers/lego/motors/*_defs.c
